...
ALTER TABLE "tenants" ALTER COLUMN "slack_team_id" DROP NOT NULL;
--> statement-breakpoint
ALTER TABLE "tenants" ADD COLUMN "display_name" text DEFAULT 'My workspace' NOT NULL;
--> statement-breakpoint
ALTER TABLE "tenant_memberships" ADD CONSTRAINT "tenant_memberships_tenant_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenants"("id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
